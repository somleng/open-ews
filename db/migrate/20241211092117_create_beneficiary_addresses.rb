class CreateBeneficiaryAddresses < ActiveRecord::Migration[8.0]
  def change
    create_table :beneficiary_addresses do |t|
      ...
      t.index [ :iso_region_code, :administrative_division_level_2_code, :administrative_division_level_3_code, :administrative_division_level_4_code ]
      t.index [ :iso_region_code, :administrative_division_level_2_name, :administrative_division_level_3_name, :administrative_division_level_4_name ]
    end
  end
end
